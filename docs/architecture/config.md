...
- Telemetry fallback, layout binding collection, and layout edit dialog controls consume the config-owned board-binding resolver instead of carrying separate fallback target tables.
