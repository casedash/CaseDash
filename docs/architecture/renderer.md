...
- Restore dirty regions into the retained window back buffer before presenting animation frames; dirty rectangles are a renderer-internal redraw contract, not DXGI presentation metadata.
