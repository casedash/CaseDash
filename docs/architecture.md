...
- Parser and writer code share config-owned UTF-8 file helpers while keeping overlay behavior and text-preserving saves separate from higher-level config resolution.
