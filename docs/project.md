...
- Config metadata is generated into table descriptors from `src/config/config_desc.h`; keep parser, writer, color, and layout-edit metadata consumers on the non-template runtime table APIs.
