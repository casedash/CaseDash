...
- App-icon exports use the same programmatic icon renderer as the live window, tray, and dialog icons, use the current resolved theme colors including the resolved card background color, and do not depend on dashboard render scale.
