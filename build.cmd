...
set "SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT="
if defined SYSTEMTELEMETRY_CACHE_ROOT (
    set "SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT=%SYSTEMTELEMETRY_CACHE_ROOT%"
) else (
    if defined LOCALAPPDATA (
        set "SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT=%LOCALAPPDATA%\SystemTelemetry\cache"
    ) else if defined USERPROFILE (
        set "SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT=%USERPROFILE%\.systemtelemetry\cache"
    ) else (
        set "SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT=%BUILD_ROOT%\cache"
    )
)
if not defined VCPKG_DOWNLOADS set "VCPKG_DOWNLOADS=%SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT%\vcpkg\downloads"
if not defined X_VCPKG_REGISTRIES_CACHE set "X_VCPKG_REGISTRIES_CACHE=%SYSTEMTELEMETRY_CACHE_ROOT_DEFAULT%\vcpkg\registries"
